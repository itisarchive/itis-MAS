...
Repository that contains implementation of the mini-projects and solutions to the exercises for the MAS (Modeling and
Analysis of Information Systems) practical classes, taught by Emil Wcisło during studies
on [PJAIT](https://www.pja.edu.pl/en/), as well as some additional implementations for the lecture assignments.
...
repository [here](https://github.com/itisarchive/itis-MAS-Bobby).
